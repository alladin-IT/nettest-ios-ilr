...
extension UIBarButtonItem {
    ...
    /// needed because setTitleTextAttributes(attributes, for: [.normal, .selected, ...]) is not working...
    func setTitleTextAttributesForAllStates(_ attributes: [NSAttributedStringKey : Any]?) {
