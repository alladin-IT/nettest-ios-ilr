...
class QOSControlConnection: NSObject {
    ...
    /// // TODO: should use serial dispatch queue, but then qos tests don't work because of the commands
    fileprivate let socketQueue = DispatchQueue(label: "at.alladin.rmbt.controlConnectionSocketQueue", attributes: DispatchQueue.Attributes.concurrent)
