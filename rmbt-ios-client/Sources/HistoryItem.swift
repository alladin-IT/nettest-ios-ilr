...
open class HistoryItem: BasicResponse {
    ...
    ///
    open var speedDownloadClassificationColor: String?
    
    ///
    open var speedUploadClassificationColor: String?
    
    ///
    open var pingClassificationColor: String?
    
    ///
    open var pingShortClassificationColor: String?
    ...
    override open func mapping(map: Map) {
        ...
        speedDownloadClassificationColor <- map["speed_download_classification_color"]
        speedUploadClassificationColor   <- map["speed_upload_classification_color"]
        pingClassificationColor          <- map["ping_classification_color"]
        pingShortClassificationColor     <- map["ping_short_classification_color"]
    }
}
