...
extension QOSTestResult {
    ...
    ///
    public func set(_ key: String, value: AnyObject?) {
        if !readOnly {
    ...
    public func set(_ key: String, string: String?) {
        set(key, value: string as AnyObject?)
    }
    ...
    ///
    public func set(_ key: String, status: Status) {
        set(key, string: status.rawValue)
    }
}
