...
class SettingsReponse: BasicResponse {
    ...
    ///
    var advancedPosition: AdvancedPosition?
    ...
    override func mapping(map: Map) {
        ...
        client <- map["client"]
        advancedPosition <- map["advancedPosition"]
    ...
    ///
    class AdvancedPosition: Mappable {
        
        ///
        var enabled = false
        
        ///
        var options: [AdvancedPositionOption]?
        ...
        ///
        class AdvancedPositionOption: Mappable {
