...
/// Returns bundle name from Info.plist (e.g. alladin-IT NetTest)
...
///
public func RMBTValueOrNull(_ value: AnyObject!) -> AnyObject {
//    return value ?? NSNUll()
    return (value != nil) ? value : NSNull()
}

///
public func RMBTValueOrString(_ value: AnyObject!, _ result: AnyObject) -> AnyObject {
//    return value ?? result
